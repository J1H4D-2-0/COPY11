...
logo = ("""                                                                                            
MMMMMMMM""M M""M M""MMMMM""MM MMP"""""""MM M""""""'YMM 
MMMMMMMM  M M  M M  MMMMM  MM M' .mmmm  MM M  mmmm. `M 
MMMMMMMM  M M  M M         `M M         `M M  MMMMM  M 
MMMMMMMM  M M  M M  MMMMM  MM M  MMMMM  MM M  MMMMM  M 
M. `MMM' .M M  M M  MMMMM  MM M  MMMMM  MM M  MMMM' .M 
MM.     .MM M  M M  MMMMM  MM M  MMMMM  MM M       .MM 
MMMMMMMMMMM MMMM MMMMMMMMMMMM MMMMMMMMMMMM MMMMMMMMMMM 
...
def fuck():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print(" \033[38;5;46m=============================")
        print('===================================')
        print('[𝟎𝟏]\033[38;5;46m 𝑪𝒀𝑩𝑬𝑹 𝟗𝟗 JIHAD')
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[38;5;46m[✮⃝JID=JIHAD𝄟⃝]-[%s/%s]-[CP-%s]~[OK-%s] \r'%(loop,tl,len(cps),len(oks))),
            sys.stdout.flush()
...
#𝑪𝑹𝑲 𝑺𝒀𝑺𝑻𝑬𝑴✔️✔️✔️✔️✔️              
        ...
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}JID-REFRESH-JIHAD {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
